...
import visualizers.ColorGradientVisualizer;
...
public class ColorGradientSorter extends BarSorter
{
	...
	public void addCustomizationComponents(CustomizationPanel cp)
	{
		...
		leftColorButton.setToolTipText(ToolTips.getDescriptionFor(ToolTips.Keys.LEFT_COLOR));
		...
		rightColorButton.setToolTipText(ToolTips.getDescriptionFor(ToolTips.Keys.RIGHT_COLOR));
